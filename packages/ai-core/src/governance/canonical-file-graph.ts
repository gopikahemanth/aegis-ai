...
export const CANONICAL_FILES: CanonicalFileEntry[] = [
  ...
  },
  {
    ...
    semanticAliases: ["server/controllers/AuthController.ts", "server/controllers/user.controller.ts"],
  ...
  },
  {
    ...
    semanticAliases: ["src/pages/Login.tsx", "src/features/auth/Login.tsx"],
    requiredExports: ["default"],
  ...
  },
  {
    ...
    semanticAliases: ["src/pages/Register.tsx", "src/features/auth/Register.tsx", "src/features/auth/SignupPage.tsx"],
    requiredExports: ["default"],
    allowedImports: ["src/services/api", "src/hooks/useAuth"],
    required: true,
    category: "frontend-page",
