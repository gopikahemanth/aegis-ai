...
`;
      ...
      (pkg.devDependencies as Record<string, string>)["typescript"] = "^5.3.3";
      (pkg.devDependencies as Record<string, string>)["vite"] = "^5.4.0";
      (pkg.devDependencies as Record<string, string>)["@types/node"] = "^20.11.0";
